...
print('Load model')
# model = models.vgg13()
netG.load_state_dict(torch.load('/home/dell/OOD_Detection/Confident_classifier/results/joint_confidence_loss/20116/netG_epoch_100.pth'))
print(netG)
...
def generate(epoch):
        ...
        vutils.save_image(fake.data, '%s/generate_GAN_OOD/%d.png'%(args.outf, epoch), normalize=True)
